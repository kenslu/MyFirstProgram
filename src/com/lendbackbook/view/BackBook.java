			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(currentBook.next()) {//该书存在
						if(currentBook.getInt("lend") == 0) {
							JOptionPane.showMessageDialog(null, "该书已经归还，请归还其他图书！");
							return;
						}
						String bookName = currentBook.getString("bookName");
						
						int lendBook = bookdao.back(con,textid,userMessage);//
